...
def diff_files(
    expected_file: str, actual_file: str, *diff_options: DiffOption
) -> DiffResult:
...
def diff_files_gnu(
    diff_cmd: str, expected_file: str, actual_file: str, *diff_options: DiffOption
) -> DiffResult:
    command = [
        diff_cmd,
        "--minimal",
...
def diff_run(
    command: List[str], has_fences: bool, expected_file: str, actual_file: str
) -> DiffResult:
    expected = file_nlines(expected_file)
    actual = file_nlines(actual_file)
