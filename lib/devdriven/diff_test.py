...
def test_diff_files():
    ...
    result = diff.diff_files(
        "tests/devdriven/data/expected.txt", "tests/devdriven/data/actual.txt"
    )
    expected = {
        "correct": False,
        "expected": 11,
    ...
    result = diff.diff_files(
        "tests/devdriven/data/expected.txt", "tests/devdriven/data/expected.txt"
    )
    expected = {
        "correct": True,
        "expected": 11,
...
def test_diff_files_stats():
    ...
    assert diff_files_stats(10, 9, 1, 0, 1) == {
        ...
        "new": 0,
        "differences": 1,
        "correct_ratio": 0.9473684210526315,
        "correct_percent": 94.74,
        "exit_code": 1,
    }
    ...
    assert diff_files_stats(10, 11, 0, 1, 1) == {
        ...
        "new": 1,
        "differences": 1,
        "correct_ratio": 0.9523809523809523,
        "correct_percent": 95.24,
        "exit_code": 1,
    }
