...
if(history.pushState){var url_query_string=searchParams.toString();var newurl=window.location.protocol+"//"+window.location.host+window.location.pathname+'?'+url_query_string;window.history.pushState({path:newurl},'',newurl);}}
