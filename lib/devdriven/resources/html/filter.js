...
var cx_make_filter =
    ...
    function make_parser() {
        ...
        var name_rx    = pc.trim(pc.rx(name_pat));
        var name       = pc.pred(name_rx, to_col_idx);
        var pat_quote  = pc.trim(pc.rx(quote_pat));
        var pat_rx_    = pc.trim(pc.rx(rx_pat));
        var pat_rx     = pc.pred(pat_rx_, pc.regexp_maybe);
        var pat_word   = pc.trim(pc.rx(word_pat));
