var cx_make_filter=function(table_id_){var debug=false;var debug_init=false||debug;var debug_cols=false||debug;var debug_match=false||debug;var debug_row=false;var debug_row_data=false||debug;var debug_event=false;var debug_history=false;var table_id=table_id_;var dom_window,dom_table,dom_rows,dom_cols,dom_filter_input,dom_matched_row_count;var col_name_to_idx=new Map();var col_idx_to_name=new Map();var col_to_data_idx=new Map();var col_idxs=[];function to_col_idx(x){return col_name_to_idx.get(x)||col_name_to_idx.get(col_idx_to_name.get(x));}
